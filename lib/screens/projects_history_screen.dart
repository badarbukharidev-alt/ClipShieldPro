...
class _ProjectsHistoryScreenState extends State<ProjectsHistoryScreen> {
  ...
  final List<String> _filters = ["All", "Shorts", "Transformed", "Done", "Drafts"];
                                        ...
                                        Row(
                                          children: [
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                color: isMode1 ? AppColors.softTangerine : AppColors.softGrape,
                                  ...
                                  Container(
                                    ...
                                    child: Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 10.5,
                                        fontWeight: FontWeight.w800,
                                        color: p.status == 'done' ? AppColors.accentTangerine : AppColors.mut,
                                      ),
                                    ),
                                  ),
                                ],
