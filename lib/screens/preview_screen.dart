...
class _PreviewScreenState extends State<PreviewScreen> {
  ...
  Future<void> _initControllers() async {
    _transformedController = VideoPlayerController.file(File(widget.transformedVideoPath));
    _originalController = VideoPlayerController.file(File(widget.originalVideoPath));
  ...
  Future<void> _shareClip() async {
    final path = _showTransformed ? widget.transformedVideoPath : widget.originalVideoPath;
    await Share.shareXFiles([XFile(path)], text: widget.title);
  }

  @override
  Widget build(BuildContext context) {
    final activeController = _showTransformed ? _transformedController : _originalController;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: _showTransformed ? AppColors.accentTangerine : Colors.white24,
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                        decoration: BoxDecoration(
                          color: !_showTransformed ? Colors.white : Colors.transparent,
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          "Original",
                          style: TextStyle(
                            ...
                            color: !_showTransformed ? AppColors.ink : Colors.white70,
                          ),
                        ),
                      ),
                    ),
                    GestureDetector(
                      ...
                      child: Container(
                        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                        decoration: BoxDecoration(
                          color: _showTransformed ? AppColors.accentTangerine : Colors.transparent,
                          borderRadius: BorderRadius.circular(20),
                        ),
                        child: Text(
                          "Transformed (9-Layer)",
                          style: TextStyle(
                            fontSize: 12.5,
                            fontWeight: FontWeight.w700,
                            color: _showTransformed ? Colors.white : Colors.white70,
                          ),
                        ),
                      ),
                    ),
              ...
              // Video Canvas (9:16 portrait viewport)
              Expanded(
                child: Container(
                  decoration: BoxDecoration(
                    color: Colors.black,
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      label: const Text("Share Asset", style: TextStyle(color: Colors.white)),
