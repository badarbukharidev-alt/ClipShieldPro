...
class ColorLayer extends TransformationLayer {
  ...
  FilterResult apply(FilterContext context) {
    ...
    return FilterResult(
      ...
      logMessage:
          "Layer 6 applied: Hue shift ${hue.toStringAsFixed(2)}°, Saturation ${sat.toStringAsFixed(3)}x.",
    );
  }
